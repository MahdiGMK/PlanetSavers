...
{
    Texture2D texMinus;
    Texture2D texMinusSelected;
    Texture2D texDot;
    Texture2D texDotSnap;
    Texture2D texDotPlus;
    Texture2D texDotSelected;
    Texture2D texDotSelectedSnap;
    ...
    private void OnEnable()
    {
        ...
        {
            texMinus = Ferr_EditorTools.GetGizmo("dot-minus.png");
            texMinusSelected = Ferr_EditorTools.GetGizmo("dot-minus-selected.png");
            texDot = Ferr_EditorTools.GetGizmo("dot.png");
            texDotSnap = Ferr_EditorTools.GetGizmo("dot-snap.png");
            texDotPlus = Ferr_EditorTools.GetGizmo("dot-plus.png");
            texDotSelected = Ferr_EditorTools.GetGizmo("dot-selected.png");
            texDotSelectedSnap = Ferr_EditorTools.GetGizmo("dot-selected-snap.png");

            texLeft = Ferr_EditorTools.GetGizmo("dot-left.png");
            texRight = Ferr_EditorTools.GetGizmo("dot-right.png");
            texTop = Ferr_EditorTools.GetGizmo("dot-top.png");
            texBottom = Ferr_EditorTools.GetGizmo("dot-down.png");
            texAuto = Ferr_EditorTools.GetGizmo("dot-auto.png");
            texReset = Ferr_EditorTools.GetGizmo("dot-reset.png");
            texScale = Ferr_EditorTools.GetGizmo("dot-scale.png");
        }
    }
            ...
            switch (Event.current.type)
            {
                ...
                case EventType.mouseUp:
                    ...
                    for (int i = 0; i < path.pathVerts.Count; i += 1)
                    {
                        ...
                        if (r.Contains(HandleUtility.WorldToGUIPoint(path.transform.TransformPoint(path.pathVerts[i]))) && selectedPoints != null)
                        {
